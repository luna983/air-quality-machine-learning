# usage:
# nohup python3 map_extracter_merra2.py PBLH RH T2M V2M U2M PS COSC AODANA TO3 &
...
if __name__ == '__main__':
    ...
    # define paths
    monitor_coords_file = "../../data/csv/monitor/monitor_coords.csv"
    ...
    for input_var in input_vars:
        ...
        # define input output root path
        raster_root = os.path.join("../../data/processed/", input_var)
        output_root = os.path.join("../../data/csv/", input_var + "_csv")
        ...
        for raster_file in tqdm(raster_files):
            ...
            # rescale pressure
            if input_var in ['PS']:
                raster = raster / 1000 # change unit to kPa
            # censor
            ...
            output.assign(**kwargs).to_csv(os.path.join(output_root, raster_info + '.csv'),
                                           index=False)
